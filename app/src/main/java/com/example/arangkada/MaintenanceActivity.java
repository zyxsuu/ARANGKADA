...
public class MaintenanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnLogMaintenance)
                .setOnClickListener(v ->
                        showLogMaintenanceDialog()
                );

        TextView btnEditIntervals =
                findViewById(R.id.btnEditIntervals);

        if (btnEditIntervals != null) {
            btnEditIntervals.setOnClickListener(v ->
                    showEditIntervalsDialog()
            );
        }
    ...
    private void refreshMaintenanceData() {
        ...
        currentOdometer =
                shiftManager.getCurrentOdometer();

        TextView tvOdometer =
                findViewById(
                        R.id.tvCurrentOdometer
                );
        ...
        LinearLayout logsContainer =
                findViewById(
                        R.id.llMaintenanceLogsContainer
                );

        logsContainer.removeAllViews();

        Cursor cursor =
                dbHelper.getAllMaintenanceLogs(
                        userEmail
                );
            ...
            do {
                ...
                View logView =
                        LayoutInflater.from(this)
                                .inflate(
                                        R.layout.item_maintenance_log,
                                        logsContainer,
                                        false
                                );

                TextView title =
                        logView.findViewById(
                                R.id.tvLogTitle
                        );
    ...
    private void updateIntervalCardDynamic(
            String type,
            double interval,
            double currentOdo
    ) {
